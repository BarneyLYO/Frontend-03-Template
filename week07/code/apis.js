...
{
	let api = new Set();
	let objects = ['PhotoCapabilities', 'MediaSettingsRange', 'ImageCapture'];
	objects.forEach(o => api.add(o));
	names = names.filter(e => !api.has(e));
}
...
{
	let api = new Set();
	let objects = ['NetworkInformation', 'NavigatorNetworkInformation'];
	objects.forEach(o => api.add(o));
	names = names.filter(e => !api.has(e));
}
...
{
	let fetch = new Set();
	let objects = ['Headers', 'Body', 'Request'];
...
// https://notifications.spec.whatwg.org/
{
	...
	let objects = ['Notification', 'NotificationEvent'];
